 ...
 */
const plotCirclePoints = (context, xc, yc, x, y, color = [0, 0, 0]) => {
...
const circleTrig = (context, xc, yc, r, color) => {
  const theta = 1 / r
...
// Now DDA.
const circleDDA = (context, xc, yc, r, color) => {
  const epsilon = 1 / r
  let x = r
  let y = 0
...
const circleBres1 = (context, xc, yc, r, color) => {
  let p = 3 - 2 * r
  let x = 0
  let y = r
...
// And another...
const circleBres2 = (context, xc, yc, r, color) => {
  let x = 0
  let y = r
  let e = 1 - r
  let u = 1
...
// Last but not least...
const circleBres3 = (context, xc, yc, r, color) => {
  let x = r
  let y = 0
  let e = 0
