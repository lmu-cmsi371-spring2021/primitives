...
export default (() => {
  ...
  const drawBase = renderingContext => {
    ...
    renderingContext.fillRect(-(COUNTER_WIDTH / 2), -(COUNTER_HEIGHT / 2), COUNTER_WIDTH, COUNTER_HEIGHT)

    renderingContext.fillStyle = SHADOW_COLOR
    renderingContext.fillRect(-(COUNTER_WIDTH / 2), -(COUNTER_HEIGHT / 2), COUNTER_WIDTH, COUNTER_HEIGHT / 6)
  ...
  const drawCounter = renderingContext => {
